...
const alochatMain = Color(0xFF00B393);
...
// const SplashBackgroundSolidColor = Color(0xFF01826b); //applies this colors to fill the areas around splash screen.  Color Code: 0xFF01826b for Whatsapp theme & 0xFFFFFFFF for messenger theme.
const SplashBackgroundSolidColor = alochatMain;
final statusBarColor = alochatMain;
...
const Agora_APP_IDD =
    '475c973e2465494a90bcab83535e620f'; // Grab it from: https://www.agora.io/en/
...
const GiphyAPIKey = 'mFYldf0UHh0w7JSYpmoQfRTIZeubM88o'; // Grab it from: https://developers.giphy.com/

//*--App Configurations---
const Appname =
    'AloChat'; //app name shown evrywhere with the app where required
const DEFAULT_COUNTTRYCODE_ISO =
    'LA'; //default country ISO 2 letter for login screen
const DEFAULT_COUNTTRYCODE_NUMBER =
    '+856'; //default country code number for login screen
const FONTFAMILY_NAME =
    'Lao'; // make sure you have registered the font in pubspec.yaml
