...
class NotificationController2 {
  ...
  static Future<void> _handleBackgroundNotification(FcmSilentData silentData) async {
  ...
  static Future<void> _showNotificationWithDefaultSound(String? title, String? message,
